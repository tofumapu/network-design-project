...
**Đồ án môn học:** NT531 - Thiết kế mạng  
...
|-----------|---------|------|
| 🏢 **TP.HCM** | Trụ sở chính (HQ) | `10.1.x.x/24` |
...
### Sơ đồ OSPF Multi-Area

```mermaid
graph LR
    subgraph AREA0["OSPF Area 0 - Backbone"]
        HCM_OSPF["HCM<br/>Router-ID: 1.1.1.1 ~ 4.4.4.4"]
        DN_OSPF["Đà Nẵng<br/>Router-ID: 9.9.9.9 ~ 10.10.10.10"]
    end

    subgraph AREA1["OSPF Area 1"]
        HN_OSPF["Hà Nội<br/>Router-ID: 6.6.6.6 ~ 7.7.7.7"]
    end
...
2. File → Open → topology/fastpay-network.pkt
...
<p align="center">
  ...
  <i>Môn NT531 - Thiết kế Mạng · GVHD: ThS. Bùi Thanh Bình</i>
</p>
